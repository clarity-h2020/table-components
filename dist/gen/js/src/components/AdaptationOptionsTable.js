...
export default class AdaptationOptionsTable extends React.Component {
    ...
    adaptationCell(row) {
        return React.createElement(
            'div',
            null,
            React.createElement('img', { width: 50, height: 50, className: 'adaptationImage', src: row.original.adaptationImage, alt: '' }),
            React.createElement(
                'div',
                { className: 'adaptationText' },
                React.createElement(
                    'p',
                    null,
                    row.original.adaptation
                )
            )
        );
    }
